...
GCPRCNT_SCRIPT_PATH = '/home/bardya/usr/scripts/bash_scripts/gc_track_for_igv.sh'
GCPRCNT_WINDOW_SIZE = 1000
GCSKEW_SCRIPT_PATH = '/home/bardya/usr/scripts/bash_scripts/gcskew_track_for_igv.sh'
GCSKEW_WINDOW_SIZE = 5000

COORDS2GFF_SCRIPT_PATH = '/home/bardya/Dropbox/abio/BioParsing/coords2gff3.py'
LENGTH_DISTR_SCRIPT_PATH = '/home/bardya/usr/scripts/bash_scripts/collect_seqtype_length_distribution_from_gff.sh'
QUAST_PATH = '/home/bardya/usr/bin/quast-4.1/quast.py'
IGVTOOLS_CMD = ['/share/applications/java/java8/bin/java', '-Xmx1500m', '-jar ~/usr/bin/IGVTools/igvtools.jar']

barebone_session_XML = """<?xml version="1.0" encoding="UTF-8" standalone="no"?>
...
if __name__ == '__main__':
    ...
    START_WD = '/share/project/bardya/Acinetobacter/tmp/scaffolding'
    os.chdir(START_WD)
    ...
    for subject in subjectlist:
        ...
        cmd1 = ['python3', COORDS2GFF_SCRIPT_PATH, '-i', coordsfile_path, '-f', '-c', '80', '-l', '500', '-u', '-o', outpath1]
        cmd2 = ['python3', COORDS2GFF_SCRIPT_PATH, '-i', coordsfile_path, '-f', '-br', '-c', '80', '-l', '500', '-u', '-o', outpath2]
